...
public class Connect{
	...
	public static void insert(String no,String p,String n,String s,String t){
		String sql="insert into people(number,passwd,name,sex,telephone) values('"+no.trim()+"','"+p.trim()+"','"+n.trim()+"','"+s.trim()+"','"+t.trim()+"')";
		try{
			statement = con.createStatement();
			statement.execute(sql);
		}catch(Exception e){
	...
	public static void delete(String no){
		String sql="delete from people where number="+no.trim();
		try{
			statement = con.createStatement();
			statement.execute(sql);
		}catch(Exception e){
