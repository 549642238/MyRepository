...
public class RemarkDaoImpl implements IRemarkDao{
    ...
    public ArrayList<Remark> findRemark() throws Exception {
       ArrayList<Remark> remarks = new ArrayList<Remark>();
        String sql = "select username,windowname,dishname,buildname,layer,timeid,content,dishscore from view_remark";
    ...
    public ArrayList<Remark> findRemarkbyDishName(String dishname) throws Exception {
        ArrayList<Remark> remarks = new ArrayList<Remark>();
        String sql = "select username,windowname,dishname,buildname,layer,timeid,content,dishscore from view_remark where dishname=?";
        this.pstmt = this.conn.prepareStatement(sql);
    ...
    public ArrayList<Remark> findRemarkbyBLWD(String buildname, String layer,String windowname, String dishname) throws Exception {
        ArrayList<Remark> remarks = new ArrayList<Remark>();
        String sql = "select username,windowname,dishname,buildname,layer,timeid,content,dishscore from view_remark where buildname=? and layer=? and windowname=? and dishname=? ";
        this.pstmt = this.conn.prepareStatement(sql);
    ...
    public ArrayList<Remark> findRemarkbyBLW(String buildname, String layer,String windowname) throws Exception {
        ArrayList<Remark> remarks = new ArrayList<Remark>();
        String sql = "select username,windowname,dishname,buildname,layer,timeid,content,dishscore from view_remark where buildname=? and layer=? and windowname=?";
        this.pstmt = this.conn.prepareStatement(sql);
        this.pstmt.setString(1, buildname);
        this.pstmt.setString(2, layer);
        this.pstmt.setString(3, windowname);
